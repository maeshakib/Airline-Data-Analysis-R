...
This is an Airline Dataset having 227,496 flight information of an USAirport in the year 2011. There is total 21 columns in the dataset. Below is the brief of the columns.

```{r}
#load library
library(tidyverse)
#load csv from github(uploaded for Assignment_02_Group_04)
airline <- read.csv("https://raw.githubusercontent.com/maeshakib/Airline-Data-Analysis-R/main/dataset.csv", stringsAsFactors = FALSE)
#show data structure of dataset
str(airline)
```
